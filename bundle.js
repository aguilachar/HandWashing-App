var app = (function () {
    ...
    function create_fragment$3(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(div0, "class", "progress-bar svelte-9uyg1a");
    			set_style(div0, "width", /*progress*/ ctx[0] + "%");
    			attr(div1, "bp", "offset-5@md 4@md 12@sm");
    			attr(div1, "class", "progress-container svelte-9uyg1a");
    			attr(div2, "bp", "grid");
    		},
    		m(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		c() {
    			div = element("div");
    			div.innerHTML = `<img bp="offset-5@md 4@md 12@sm" src="handwashing.png" alt="handwashing steps" class="svelte-tc476n"/>`;
    			attr(div, "bp", "grid");
    		},
    		m(target, anchor) {
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c() {
    			...
    			t3 = space();
    			h6 = element("h6");
    			h6.innerHTML = `<a href="https://www.who.int/gpsc/clean_hands_protection/en/">Image Source</a>`;
    			attr(h1, "class", "svelte-ziouk0");
    			attr(h6, "class", "svelte-ziouk0");
    		},
    		m(target, anchor) {
